...
export default function ContactCard({name, number}){
    return(
        <View className="bg-white w-full flex justify-center items-center">
            <View className="w-full bg-athena-gray-100 rounded-2xl p-3 flex flex-row justify-start items-center">
                <View className=" bg-athena-red/50 rounded-md w-2/12 h-5/6 mx-4">
                </View>
                <View className="">
